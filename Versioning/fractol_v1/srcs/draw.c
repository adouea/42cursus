...
t_complex	*fractal_func(t_complex *num, t_complex *constant)
{
	t_complex	*power_2;
	t_complex	*sum;
...
int	is_in_set(t_complex *number, t_complex *constant)
{
	int			iters;
	t_complex	*temp;
...
void	draw_point(int x, int y, t_vars *vars, t_data *data)
{
	int			pos;
	int			iters;
	t_complex	*z;
